...
const boxers = [
    ...
    {name: "Bill",
    bad_responses: ["Bill was distracted by the beauty of the women on his line and put 26 pouches in a line kit inner.", "Bill found out that HR didn't want him to use the 'r' word and used it anyway. Pretty retardiff.", "Bill stole a squeeze contrast controller from the kit to use as a sex toy. Emergency surgery was required", "Bill spent his lunch break speeding down Dix Ave listening to Motorhead while pensively stroking his beard. He figured out why his count was off"],
    good_responses: [],
    },
    {name: "Harry",
    bad_responses: ["Harry made a crazy joke at Town Hall and got called down to HR. He was already missing three DFUs. Bill screwed up his count while he was gone","Harry spent his whole kit browsing the internet and ended up boxing up his pens and box cutters instead of pouches", "Harry was put on the Japan line and made good use of his scale, weighing every box. His count was flawless all day.", "Harry was put on a line with one of his daughters. Van Guilder energy pervaded the custom packaging department and everyone was magically on count"],
    good_responses: [],
    },
    {name: "Heidi",
    bad_responses: ["Heidi used 96 bags instead of 13s and we had to 100 percent a three pallet connect", "Kurt helped Heidi spot every trace of foreign matter in her kit",],
    good_responses: []
    },
    {name: "Jon",
...
const sealers = [
    {name: "Chris C",
    responses: ["Chris got his final warning from Christina for repeatedly telling boxers to box with their eyes closed. Little does he know that he could level the playing field just by getting new glasses", `Chris goes to an improv class three days a week before work. He often vents his frustration by roleplaying as a Medline Employee and screaming 'FUCK YOU' at his fellow improv actors. He forgot he was at work today and swore at ${}`]
    ...
    {name: "Jay",
    responses: ["The entire department was quarantined by the FDA due to a suspicious smell. Men in hazmat suits quickly homed in on Jay's line. The smell turned out to be Jay's breath."],
